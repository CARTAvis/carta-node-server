# CARTA Server
[![carta version](https://img.shields.io/badge/CARTA%20Version-2.0.0--dev.2-brightgreen)](https://github.com/CARTAvis/carta-backend/releases/tag/v2.0.0-dev.2)
...
- Checkout and build [carta-backend](https://github.com/CARTAvis/carta-backend) using the `v2.0.0-dev.2` tag (or create the appropriate container). Detailed instructions for Ubuntu 20.04 are available [here](docs/ubuntu_focal_detailed_install.md).
